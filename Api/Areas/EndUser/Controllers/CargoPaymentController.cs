...
namespace Api.Areas.EndUser.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class CargoPaymentController : Controller
    {
        private readonly ICargoService _cargoService;
        private readonly ICurrentUserHelper _currentUserHelper;
        private readonly IPaymentService _paymentService;
        public CargoPaymentController(ICargoService cargoService, ICurrentUserHelper currentUserHelper, IPaymentService paymentService)
        {
        ...
        public async Task<IActionResult> Post(PaymentStartDto payment)
        {
            ...
            var dto = await _paymentService.InsertCargoPaymentAsyncDto(payment);
            return Ok(dto);
        }
    }
}
