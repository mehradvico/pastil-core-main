...
namespace Api.Areas.Companion.Controllers
{
    ...
    public class CompanionAssistancePackagePictureController : ControllerBase
    {
        ...
        public CompanionAssistancePackagePictureController(ICompanionAssistancePackagePictureService companionassistancepackagePictureService, ICurrentUserHelper currentUser)
        {
