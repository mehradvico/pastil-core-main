...
namespace Persistence.Migrations
{
    ...
    [Migration("20250316082013_Mig_Clinic")]
    partial class Mig_Clinic
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicAssistancePackageClinicReserve", b =>
                {
                    b.Property<long>("ClinicAssistancePackagesId")
                        .HasColumnType("bigint");

                    b.Property<long>("ClinicReservesId")
                        .HasColumnType("bigint");

                    b.HasKey("ClinicAssistancePackagesId", "ClinicReservesId");

                    b.HasIndex("ClinicReservesId");

                    b.ToTable("ClinicAssistancePackageClinicReserve");
                });
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.Assistance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.Clinic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ClinicAssistances");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistancePackage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ClinicAssistanceId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ClinicAssistanceId");

                    b.ToTable("ClinicAssistancePackages");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistanceTime", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ClinicAssistanceTimes");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistanceUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ClinicAssistanceUsers");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.ClinicReserve", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ClinicAssistanceTimeId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ClinicUserId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ClinicAssistanceTimeId");

                    b.HasIndex("ClinicUserId");

                    b.HasIndex("UserPetId");

                    b.ToTable("ClinicReserves");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.WeekDay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ClinicAssistancePackageClinicReserve", b =>
                {
                    b.HasOne("Entities.Entities.Clinic.ClinicAssistancePackage", null)
                        .WithMany()
                        .HasForeignKey("ClinicAssistancePackagesId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.Entities.Clinic.ClinicReserve", null)
                        .WithMany()
                        .HasForeignKey("ClinicReservesId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistance", b =>
                {
                    b.HasOne("Entities.Entities.Clinic.Assistance", "Assistance")
                        .WithMany()
                        .HasForeignKey("AssistanceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.Entities.Clinic.Clinic", "Clinic")
                        .WithMany("ClinicAssistances")
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistancePackage", b =>
                {
                    b.HasOne("Entities.Entities.Clinic.ClinicAssistance", "ClinicAssistance")
                        .WithMany("ClinicAssistancePackages")
                        .HasForeignKey("ClinicAssistanceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ClinicAssistance");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistanceTime", b =>
                {
                    b.HasOne("Entities.Entities.Clinic.ClinicAssistance", "ClinicAssistance")
                        .WithMany("ClinicAssistanceTimes")
                        .HasForeignKey("ClinicAssistanceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.Entities.Clinic.WeekDay", "WeekDay")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistanceUser", b =>
                {
                    b.HasOne("Entities.Entities.Clinic.ClinicAssistance", "ClinicAssistance")
                        .WithMany("ClinicAssistanceUsers")
                        .HasForeignKey("ClinicAssistanceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.ClinicReserve", b =>
                {
                    ...
                    b.HasOne("Entities.Entities.Clinic.ClinicAssistanceTime", "ClinicAssistanceTime")
                        .WithMany()
                        .HasForeignKey("ClinicAssistanceTimeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.Entities.Security.User", "ClinicUser")
                        .WithMany()
                    ...
                    b.Navigation("ClinicAssistanceTime");
            ...
            modelBuilder.Entity("Entities.Entities.Clinic.Clinic", b =>
                {
                    b.Navigation("ClinicAssistances");
                });

            modelBuilder.Entity("Entities.Entities.Clinic.ClinicAssistance", b =>
                {
                    b.Navigation("ClinicAssistancePackages");

                    b.Navigation("ClinicAssistanceTimes");

                    b.Navigation("ClinicAssistanceUsers");
                });
